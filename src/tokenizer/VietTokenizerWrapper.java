 ...
 */
public final class VietTokenizerWrapper {
	 ...
	 * Default constructor
	 */
	public VietTokenizerWrapper() {
		tokenizer = TokenizerProvider.getInstance();
	}
	public VietTokenizerWrapper(String prefix) {
		System.out.println(prefix);
		tokenizer = TokenizerProvider.getInstance(prefix);
	}
	/**
	...
	public static void main(String[] args) {
	    ...
	    try {
	        ...
	        // tokenize
	        VietTokenizerWrapper vietTokenizer = new VietTokenizerWrapper();
